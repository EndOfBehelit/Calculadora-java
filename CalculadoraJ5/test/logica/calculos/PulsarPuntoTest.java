...
class PulsarPuntoTest {
	 ...
	 */
	@Test
	void testPulsarPuntoNumeroSinComa() {
	 ...
	 */
	@Test
	void testPulsarPuntoNumeroConComa() {
		Calculos ca = new Calculos();
		ca.pulsarNumero("4");
		ca.pulsarPunto();
		ca.pulsarPunto();
	 ...
	 */
	@Test
	void testPulsarPuntoPrimerBoton() {
		Calculos ca = new Calculos();
		ca.pulsarPunto();
	 ...
	 */
	@Test
	void testPulsarPuntoPrimerBotonDespuesDeOperador() {
		Calculos ca = new Calculos();
		ca.pulsarNumero("4");
		ca.pulsarOperacion("+");
		ca.pulsarPunto();
